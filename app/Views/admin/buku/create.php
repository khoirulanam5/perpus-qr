...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="fw-semibold text-dark text-uppercase mb-0">Create Buku</h5>
            </div>
            <div>
                ...
                <div class="col-sm-10">
                    <select id="rak_id" name="rak_id"
                        ...
                        <?php foreach ($raks as $r) : ?>
                            <option value="<?= $r->id ?>" <?= old('rak_id') == $r->id ? 'selected' : ''; ?>><?= esc($r->kode_rak . ' | ' . $r->nama_rak) ?></option>
                        <?php endforeach ?>
                    </select>
                    <?php if (session('errors.rak_id')) : ?>
                        <div class="invalid-feedback"><?= session('errors.rak_id') ?></div>
                    <?php endif ?>
                </div>
            </div>
                ...
                <div class="col-sm-10">
                    <select id="tema_id" name="tema_id[]"
                        ...
                        <?php foreach ($temas as $t) : ?>
                            <option value="<?= $t->id ?>" <?= old('tema_id') == $t->id ? 'selected' : ''; ?>><?= esc($t->nama) ?></option>
                        <?php endforeach ?>
                    </select>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="file" name="sampul" id="sampul" accept="image/*"
                        ...
                        onchange="previewSampul(this)" required>
                    <?php if (session('errors.sampul')) : ?>
                        <div class="invalid-feedback"><?= session('errors.sampul') ?></div>
                    <?php endif ?>

                    <div class="mt-2">
                        <img id="sampul-preview" src="#" alt="Preview Sampul" class="img-fluid rounded shadow-sm d-none" width="150">
                    </div>
                </div>
            </div>
