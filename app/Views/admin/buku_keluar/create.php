...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="fw-semibold text-dark text-uppercase mb-0">Create Buku Keluar</h5>
            </div>
            <div>
        ...
        <form action="<?= base_url('buku_keluar') ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <select id="jenis_keluar" name="jenis_keluar"
                        ...
                        <option value="donasi" <?= old('jenis_keluar') == 'donasi' ? 'selected' : ''; ?>>Donasi</option>
                        <option value="musnahkan" <?= old('jenis_keluar') == 'musnahkan' ? 'selected' : ''; ?>>Musnahkan</option>
                    </select>
