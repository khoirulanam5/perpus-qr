...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="fw-semibold text-dark text-uppercase mb-0">Edit Buku Masuk</h5>
            </div>
            <div>
        ...
        <form action="<?= base_url('buku_masuk/' . $bukuMasuk->id) ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
                ...
                <div class="col-sm-10">
                    <select id="buku_id" name="buku_id"
                        ...
                        <?php foreach ($bukus as $buku) : ?>
                            <option value="<?= $buku->id ?>" <?= old('buku_id', $bukuMasuk->buku_id) == $buku->id ? 'selected' : ''; ?>><?= esc($buku->kode_buku . ' | ' . $buku->judul) ?></option>
                        <?php endforeach ?>
                    </select>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" name="jumlah_masuk" id="jumlah_masuk"
                        ...
                        value="<?= old('jumlah_masuk', $bukuMasuk->jumlah_masuk) ?>"
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="date" name="tanggal_masuk" id="tanggal_masuk"
                        ...
                        value="<?= old('tanggal_masuk', $bukuMasuk->tanggal_masuk) ?>"
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="diperoleh_dari" id="diperoleh_dari"
                        ...
                        value="<?= old('diperoleh_dari', $bukuMasuk->diperoleh_dari) ?>"
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="keterangan" id="keterangan"
                        ...
                        value="<?= old('keterangan', $bukuMasuk->keterangan) ?>"
