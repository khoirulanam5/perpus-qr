...
<div class="card">
    <div class="card-body">
        ...
        <form action="<?= base_url('anggota/' . $anggota->id) ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <select id="status" name="status"
                        ...
                        <option value="suspend" <?= old('status', $anggota->status) == "suspend" ? 'selected' : ''; ?>>suspend</option>
                        <option value="nonaktif" <?= old('status', $anggota->status) == "nonaktif" ? 'selected' : ''; ?>>suspend</option>
                    </select>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="mt-2">
                        <img id="foto-preview" src="<?= base_url('images/anggota/' . $anggota->foto) ?>" alt="Preview foto" class="img-fluid rounded shadow-sm" width="150">
                    </div>
                </div>
            </div>
